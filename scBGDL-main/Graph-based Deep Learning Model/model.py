...
class GraphAttentionLayer(nn.Module):
    ...
    def __init__(self, in_features, out_features=None, heads=2, concat=False, return_attention_weights=True,dropout=0.,
        ...
        self.conv = GATConv(in_features, self.out_features, heads=heads, concat=concat)
...
class MinCutPoolLayer(nn.Module):
    ...
    def __init__(self, in_features,pool_size=100, return_dense=False):
        ...
        self.mlp = nn.Linear(self.in_features, pool_size)
...
class GDL(torch.nn.Module):
    def __init__(self, input_dim):
        ...
        self.conv1 = GraphAttentionLayer(input_dim, 512, heads=4)
        self.conv2 = GraphAttentionLayer(512, 512, heads=4)
        self.conv3 = GraphAttentionLayer(512, 512, heads=4)
